...
if(isset($_POST['cadastrar'])){    
    ...
    if($nome == '' or $sobrenome =='' or $email == '' or $senha == '' or $cep == '' or $cidade == '' or $estado == '' or $rua == '' or $bairro == '' or $numero == ''){
        ...
        $erro
            ...
            inserircadastro($nome,$sobrenome,$email,$senhasegura,$cep,$cidade,$estado,$rua,$bairro,$numero,$nameImagem);
            lerusuario($email);
 ...
 * @return void
 */
function inserircadastro($nome,$sobrenome,$email,$senhasegura,$cep,$cidade,$estado,$rua,$bairro,$numero,$nameImagem){
    $connection = connection();
    $sql = "insert into usuarios(nome,sobrenome,email,senha,cep,cidade,estado,rua,bairro,numero,avatar)
    value (:nome,:sobrenome,:email,:senha,:cep,:cidade,:estado,:rua,:bairro,:numero,:avatar)";
